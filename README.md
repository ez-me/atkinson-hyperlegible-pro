...
* [Download](./archive/refs/heads/release.zip) the font from the release branch.
* Extract the file to reveal additional folders inside. Find the Open Type Format (.otf) files for the four Atkinson Hyperlegible Pro fonts (regular, italic, bold, bold italic) inside the “[fonts/otf](./tree/main/fonts/otf)” folder.
...
Please read our [contributing guidelines](./blob/main/.github/CONTRIBUTING.md)
